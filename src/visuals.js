const visuals=[
  ...
  {id:'acre3',group:'land',title:'3-acre compact homestead',kicker:'Blueprint · 3 acres',description:'A tight serviced core where parcel shape, sun and wastewater space matter immediately.',src:'assets/visual-guides/blueprint-3-acre.svg',alt:'Conceptual three-acre homestead blueprint with house, well, wastewater reserve, food production, workshop, privacy and poultry zones.'},
  {id:'acre10',group:'land',title:'10-acre working homestead',kicker:'Blueprint · 10 acres',description:'A balanced layout that keeps daily chores close and gives lower-frequency uses room to spread.',src:'assets/visual-guides/blueprint-10-acre.svg',alt:'Conceptual ten-acre working homestead blueprint with a serviced core, intensive food production, flex field, woodland, well and wastewater reserve.'},
  {id:'acre20',group:'land',title:'20-acre smallholding',kicker:'Blueprint · 20 acres',description:'A true smallholding layout with rotational pasture, woodlot and the maintenance burden made explicit.',src:'assets/visual-guides/blueprint-20-acre.svg',alt:'Conceptual twenty-acre smallholding blueprint with house, barn, garden, orchard, two paddocks, flex field, woodlot, well and wastewater reserve.'},
  ...
  {id:'food',group:'food',title:'Food production pathways',kicker:'Operating pathways',description:'A branching path from kitchen-scale abundance to a smallholding, organised by workload and infrastructure.',src:'assets/visual-guides/food-production-pathways.svg',alt:'Food production pathways from kitchen-scale growing through a household food system to a smallholding with optional orchard, greenhouse and grazing branches.'},
